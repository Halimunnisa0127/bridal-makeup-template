...
const galleryData = {
  'Traditional Bride': [bride1, bride2, bride3, bride4, bride5],
  'Engagement': [enagement1, enagement2, enagement3, enagement4],
  'Haldi': [haldi, haldi1, haldi2, haldi3],
  'Mehendi': [mehandi, mehandi1, mehandi2, mehandi3],
  'Baby Shower': [babyshower, babyshower1, babyshower2, babyshower3]
};
      ...
      <AnimatePresence>
        {selectedImage && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-xl p-4 sm:p-8 pt-[env(safe-area-inset-top,1rem)]"
            onClick={() => setSelectedImage(null)}
          >
            <button
              className="absolute top-4 right-4 sm:top-6 sm:right-6 w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition-colors z-[110] focus-visible:outline-none"
              onClick={() => setSelectedImage(null)}
            ...
            <motion.div
              ...
              className="relative max-w-4xl max-h-[85vh] w-full rounded-2xl overflow-hidden shadow-2xl shadow-amber-500/20"
