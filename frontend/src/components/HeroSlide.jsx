  ...
  return (
    <SlideSection className="relative min-h-screen flex items-center overflow-hidden bg-[#0A0A0E]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[-10%] right-[-10%] w-[60%] h-[70%] bg-[#5C4033]/20 rounded-full blur-[150px]" />
        <div className="absolute bottom-[-10%] right-[10%] w-[40%] h-[50%] bg-[#8B6508]/15 rounded-full blur-[120px]" />
        {/* Luxury Vignette */}
      ...
      >
        <motion.img 
          ...
          // Object-position right top helps keep the face visible when zooming out slightly
          className="w-full h-full object-cover object-[80%_15%] scale-[1.05]"
        />
        {/* Dark gradient overlay from left to right for text readability */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#0A0A0E] via-[#0A0A0E]/80 to-transparent z-10" />
        ...
        <div className="lg:col-span-8 space-y-12">
          <div className="space-y-8">
            <motion.h1 
              ...
              animate="visible"
              variants={fadeUp}
              className="text-5xl md:text-6xl lg:text-7xl xl:text-[5rem] text-white font-light tracking-tight text-balance leading-[1.05]"
            >
            ...
            <motion.p 
              ...
              animate="visible"
              variants={fadeUp}
              className="text-lg md:text-xl lg:text-2xl text-zinc-300 max-w-2xl font-light leading-relaxed tracking-wide opacity-90"
            >
          ...
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="relative px-8 py-4 bg-gradient-to-r from-amber-500 via-amber-400 to-amber-600 text-[#0A0A0E] font-medium text-base md:text-lg rounded-full overflow-hidden shadow-[0_0_20px_rgba(251,191,36,0.3)] hover:shadow-[0_0_30px_rgba(251,191,36,0.6)] transition-all duration-300"
            >
